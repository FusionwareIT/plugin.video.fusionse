...
def manual_search(item):
    logger.info("fusionse.channels.trailertools manual_search")
...
def tmdb_trailers(item, type="movie"):
    logger.info("fusionse.channels.trailertools tmdb_trailers")
...
def youtube_search(item):
    logger.info("fusionse.channels.trailertools youtube_search")
    itemlist = []
...
def abandomoviez_search(item):
    logger.info("fusionse.channels.trailertools abandomoviez_search")
...
def search_links_abando(item):
    logger.info("fusionse.channels.trailertools search_links_abando")
...
def filmaffinity_search(item):
    logger.info("fusionse.channels.trailertools filmaffinity_search")
...
def jayhap_search(item):
    logger.info("fusionse.channels.trailertools jayhap_search")
