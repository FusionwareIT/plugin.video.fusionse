...
def get_video_url(page_url, premium=False, user="", password="", video_password=""):
    logger.info("fusionse.servers.dailymotion get_video_url(page_url='%s')" % page_url)
    video_urls = []
    ...
    for video_url in video_urls:
        logger.info("fusionse.servers.dailymotion %s - %s" % (video_url[0], video_url[1]))
...
def find_videos(data):
    ...
    logger.info("fusionse.servers.dailymotion find_videos #" + patronvideos + "#")
