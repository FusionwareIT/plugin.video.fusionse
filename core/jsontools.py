...
def loads(*args, **kwargs):
    ...
    try:
        #logger.info("fusionse.core.jsontools loads Probando json incluido en el interprete")
        import json
    ...
    try:
        logger.info("fusionse.core.jsontools loads Probando simplejson incluido en el interprete")
    ...
    try:
        logger.info("fusionse.core.jsontools loads Probando simplejson en el directorio lib")
...
def load_json(data):
    ...
    try:
        #logger.info("fusionse.core.jsontools.load_json Probando simplejson en directorio lib")
        from lib import simplejson
        json_data = simplejson.loads(data, object_hook= to_utf8)
        logger.info("fusionse.core.jsontools.load_json -> "+repr(json_data))
        return json_data
    except:
        logger.info(traceback.format_exc())

        try:
            logger.info("fusionse.core.jsontools.load_json Probando simplejson incluido en el interprete")
            import simplejson
            json_data = simplejson.loads(data, object_hook=to_utf8)
            logger.info("fusionse.core.jsontools.load_json -> "+repr(json_data))
            return json_data
            ...
            try:
                logger.info("fusionse.core.jsontools.load_json Probando json incluido en el interprete")
                import json
                ...
                try:
                    logger.info("fusionse.core.jsontools.load_json Probando JSON de Plex")
    ...
    logger.info("fusionse.core.jsontools.load_json No se ha encontrado un parser de JSON valido")
    logger.info("fusionse.core.jsontools.load_json -> (nada)")
    return ""


def dump_json(data):
    #logger.info("fusionse.core.jsontools.dump_json Probando simplejson en directorio lib")
    ...
    try:
        ...
        logger.info("fusionse.core.jsontools.dump_json -> "+repr(json_data))
        return json_data
    except:
        logger.info(traceback.format_exc())

        try:
            logger.info("fusionse.core.jsontools.dump_json Probando simplejson incluido en el interprete")
            import simplejson
            json_data = simplejson.dumps(data, indent=4, skipkeys=True, sort_keys=True, ensure_ascii=False)
            logger.info("fusionse.core.jsontools.dump_json -> "+repr(json_data))
            return json_data
            ...
            try:
                logger.info("fusionse.core.jsontools.dump_json Probando json incluido en el interprete")
                import json
                ...
                try:
                    logger.info("fusionse.core.jsontools.dump_json Probando JSON de Plex")
    ...
    logger.info("fusionse.core.jsontools.dump_json No se ha encontrado un parser de JSON valido")
    logger.info("fusionse.core.jsontools.dump_json -> (nada)")
    return ""
...
def xmlTojson(path_xml):
    ...
    try:
        ...
        import traceback
        logger.info("fusionse.core.jsontools xmlTojson ERROR al leer el fichero y/o crear el json de "+path_xml)
        logger.info("fusionse.core.jsontools "+traceback.format_exc())
